        ...
        <div className="space-y-6">
          ...
          {order.address && order.deliveryMethod !== "PICKUP" && (
            <div className="glass-card rounded-2xl p-5">
              ...
              {order.address.latitude && order.address.longitude && order.chefLocation?.latitude && order.chefLocation?.longitude && (
                <a
                  href={`https://www.google.com/maps/dir/?api=1&origin=${order.chefLocation.latitude},${order.chefLocation.longitude}&destination=${order.address.latitude},${order.address.longitude}&travelmode=driving`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 mt-3 px-4 py-2.5 badge-gradient text-white text-sm font-semibold rounded-xl shadow hover:shadow-lg transition"
                >
          ...
          {/* Kitchen Pickup Location — for pickup orders after payment */}
            ...
            <div className="glass-card rounded-2xl p-5 border border-green-200 dark:border-green-500/20">
              ...
              <div className="text-sm text-[var(--text-soft)] space-y-2">
                ...
                {order.chefLocation.latitude && order.chefLocation.longitude && (
                  <a
                    href={`https://www.google.com/maps/dir/?api=1&destination=${order.chefLocation.latitude},${order.chefLocation.longitude}&travelmode=driving`}
                    target="_blank"
                    rel="noopener noreferrer"
